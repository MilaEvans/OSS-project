...
app = Flask(
    __name__,
    template_folder=os.path.join(os.path.dirname(__file__), 'template')  # chat.html 위치
)
        ...
        # 텍스트 입력 처리
            ...
            if interest:
                if interest == "운동":
                    ...
                    image_path = "/static/volunteer.jpg"
                elif interest == "토론":
                    bot_response += "\n토론 관련 추천: 토론 동아리, 스피치 동아리"
                    image_path = "/static/debate.jpg"
                elif interest == "IT":
                    bot_response += "\n개발 관련 추천: 프로그래밍 동아리, 해킹 동아리"
                    image_path = "/static/it.jpg"
                elif interest == "창업":
                    bot_response += "\n창업 관련 추천: 창업 동아리, 스타트업 동아리"
                    image_path = "/static/startup.jpg"
                elif interest == "문학":
                    bot_response += "\n문학 관련 추천: 문학 동아리, 창작 동아리"
                    image_path = "/static/literature.jpg"
            else:
                # MBTI도 관심사도 없을 때
                if not mbti:
